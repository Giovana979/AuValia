// Configuração do FontAwesome para substituição automática de SVGs
window.FontAwesomeConfig = {
  autoReplaceSvg: 'nest', // Opções: 'nest', 'remove', 'replace'
};

// Configuração do Tailwind CSS para customização de cores e variantes
tailwind.config = {
  theme: {
    extend: {
      colors: {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Define quantos cards são visíveis de acordo com a largura da tela
  ...
  // Evento para mover o carrossel para a esquerda
  ...
  // Evento para mover o carrossel para a direita
